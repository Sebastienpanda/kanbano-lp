    ...
    constructor() {
        afterNextRender(() => {
            ...
            if (prefersReducedMotion) {
                [".hero-banner-heading", ".hero-banner-description", ".hero-banner-actions", "kanbano-lp-checked"].forEach((sel) => {
            ...
            createTimeline()
                .add(".hero-banner-heading", {
                    opacity: [0, 1],
                    scale: [0.85, 1],
                    duration: 600,
                    ease: "out(2)",
                }, 0)
                .add(".hero-banner-description", {
                    opacity: [0, 1],
                    translateY: [24, 0],
                    duration: 500,
                    ease: "out(2)",
                }, 450)
                .add(".hero-banner-actions", {
                    opacity: [0, 1],
                    translateY: [24, 0],
                    duration: 500,
                    ease: "out(2)",
                }, 530)
                .add("kanbano-lp-checked", {
                    opacity: [0, 1],
                    translateY: [24, 0],
                    duration: 500,
                    ease: "out(2)",
